          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('logos.update', $allData->id) }}" id="myForm" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="row">
                      ...
                      <img id="show_image"
                       ...
                       src="{{(!empty($allData->image))?url('public/Upload/Logo_images/'.$allData->image):
